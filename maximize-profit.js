...
Given the daily values of a stock, create a function called maxProfitDays() that, given a list of integers, 
will return the index value of the two elements that represent the day on which one should have bought a share 
...
function maxProfitDays(stockPrices) {
    ...
    return [stockPrices.indexOf(min),stockPrices.indexOf(max)];
}

const arr = [17, 11, 60, 25, 150, 75, 31, 120];
